...
{% picture "{{ page.url }}anjoyd_stack.png" %}
...
{% picture "{{ page.url }}anjoyd_logo.png" %}
...
{% picture "{{ page.url }}anjoyd-original1.jpg" %}
...
{% picture "{{ page.url }}anjoyd-original2.jpg" %}
...
{% picture "{{ page.url }}anjoyd-brent.jpg" %}
{% picture "{{ page.url }}anjoyd_car.jpg" %}

The car gained some personality.

{% picture "{{ page.url }}anjoyd-eyes.jpg" %}
...
{% picture "{{ page.url }}anjoyd-floor.jpg" %}
...
{% picture "{{ page.url }}anjoyd-team.jpg" %}
